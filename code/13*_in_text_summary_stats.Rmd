...
**(file path: data/functional_response/outputs)**
...
mc_summary <- read_csv(here::here("data", "functional_response", "outputs", "max_consump_summary_stats.csv"))

a_summary <- read_csv(here::here("data", "functional_response", "outputs", "a_summary_stats.csv"))

h_summary <- read_csv(here::here("data", "functional_response", "outputs", "h_summary_stats.csv"))
