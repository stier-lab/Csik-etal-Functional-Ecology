...
NEW_metabolic_rates <- metabolic_rates %>% 
  ...
  select(lobster_id, temp, SMR_low15quant, mmr_overall, AS_SMR_low15quant, FAS_q15) %>% 
...
# write.csv(metabolism_foraging_data, here::here("data", "correlations", "outputs", "metabolism_foraging_data.csv"))
```