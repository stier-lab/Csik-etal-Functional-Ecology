...
Y = c*e*^E~a~(-1/kT)^ to the data where Y is a rate rate, c is a fitted constant, and E~a~ is the fitted activation energy (eV) that describes the slope of the response.
...
**(file path: data/functional_reponse/outputs)**
