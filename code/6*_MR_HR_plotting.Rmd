...
smr_plot <- ggplot() +
  geom_jitter(data = metabolic_traits, aes(x = as.factor(temp), y = SMR_low15quant), color = "black", width = 0.2, alpha = 0.2, size = 3) +
...
mmr_plot <- ggplot() +
  geom_jitter(data = metabolic_traits, aes(x = as.factor(temp), y = mmr_overall), color = "black", width = 0.2, alpha = 0.2, size = 3) +
...
aas_plot <- ggplot() +
  geom_jitter(data = metabolic_traits, aes(x = as.factor(temp), y = AS_SMR_low15quant), color = "black", width = 0.2, alpha = 0.2, size = 3) +
...
fas_plot <- ggplot() +
  geom_jitter(data = metabolic_traits, aes(x = as.factor(temp), y = FAS_q15), color = "black", width = 0.2, alpha = 0.2, size = 3) +
